...
export type ActivityType = 'ACTIVITY_SPL_TRANSFER' | 'ACTIVITY_SPL_BURN' | 'ACTIVITY_SPL_MINT' | 'ACTIVITY_SPL_CREATE_ACCOUNT' | 'ACTIVITY_SPL_TOKEN_WITHDRAW_STAKE';
...
export type DefiActivityType = 'ACTIVITY_TOKEN_SWAP' | 'ACTIVITY_AGG_TOKEN_SWAP' | 'ACTIVITY_TOKEN_ADD_LIQ' | 'ACTIVITY_TOKEN_REMOVE_LIQ' | 'ACTIVITY_SPL_TOKEN_STAKE' | 'ACTIVITY_SPL_TOKEN_UNSTAKE' | 'ACTIVITY_TOKEN_DEPOSIT_VAULT' | 'ACTIVITY_TOKEN_WITHDRAW_VAULT' | 'ACTIVITY_SPL_INIT_MINT' | 'ACTIVITY_ORDERBOOK_ORDER_PLACE';
...
export type TokenTransferActivityType = 'ACTIVITY_SPL_TRANSFER' | 'ACTIVITY_SPL_BURN' | 'ACTIVITY_SPL_MINT' | 'ACTIVITY_SPL_CREATE_ACCOUNT';
...
export type TokenDefiActivityType = 'ACTIVITY_TOKEN_SWAP' | 'ACTIVITY_AGG_TOKEN_SWAP' | 'ACTIVITY_TOKEN_ADD_LIQ' | 'ACTIVITY_TOKEN_REMOVE_LIQ' | 'ACTIVITY_SPL_TOKEN_STAKE' | 'ACTIVITY_SPL_TOKEN_UNSTAKE' | 'ACTIVITY_TOKEN_DEPOSIT_VAULT' | 'ACTIVITY_TOKEN_WITHDRAW_VAULT' | 'ACTIVITY_SPL_INIT_MINT' | 'ACTIVITY_ORDERBOOK_ORDER_PLACE';
...
//# sourceMappingURL=solscan.schema.d.ts.map